...
alias gdn='git diff --name-status $(current_branch)..dev'
...
alias gmsgc='git merge --squash dev && git commit -m "Squash Merge \"dev\" into \"$(current_branch)\""'
...
alias grs-st='git restore --staged '
alias grs-st-clean='git restore --staged . && git clean -f -d'
