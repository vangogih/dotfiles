# Generated by Powerlevel10k configuration wizard on 2020-07-09 at 15:09 MSK.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 03380.
# Wizard options: awesome-fontconfig, small icons, rainbow, ascii, 24h time, 2 lines,
# dotted, lightest-ornaments, compact, concise, transient_prompt, instant_prompt=quiet.
